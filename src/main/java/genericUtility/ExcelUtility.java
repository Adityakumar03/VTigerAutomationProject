...
/**
 * This is an Utility class for dealing with excel file
 * 
 * @author aditya
 * @version 2026-02-06
 */
public class ExcelUtility {
	...
	public String getSinglecellValueData(String sheetName, int rowIndex, int cellIndex)
	...
	/**
	 * This generic method is to fetch multiple datas from excel file
	 * 
	 * @param sheetName
	 * @param startRowIndex
	 ...
	 * @throws IOException
	 */
	public List<String> getMultipleDataFromExcel(String sheetName, int startRowIndex, int startCellIndex)
			throws EncryptedDocumentException, IOException {
		FileInputStream fis = new FileInputStream(IPathUtility.excelPath);
		Workbook wb = WorkbookFactory.create(fis);
	...
	/**
	 * This is a generic method used to write data to Excel file
	 * 
	 * @param sheetName
	 * @param rowIndex
	 * @param cellIndex
